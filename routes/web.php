...
/*
|--------------------------------------------------------------------------
| FLUXO DE CHECKOUT E FINALIZACAO (Requer Login)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| DASHBOARD & HISTORICO DO CLIENTE (Minha Conta)
|--------------------------------------------------------------------------
*/
...
// Rota para a vitrine publica (onde estao os filtros)
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::delete('/admin/shoppable/delete/{id}', [AdminController::class, 'deleteHotspot'])->name('admin.deleteHotspot');
    ...
    Route::get('/vendas', [VendaController::class, 'index'])->name('admin.vendas.index');
