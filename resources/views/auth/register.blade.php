        ...
        <form class="login-form" method="POST" action="{{ route('register') }}">
          ...
          <div style="display: flex; gap: 15px; flex-wrap: wrap;">
            ...
            <div class="input-group" style="flex: 1; min-width: 140px;">
                ...
                <input type="text" id="telefone" name="telefone" value="{{ old('telefone') }}" placeholder="(00) 00000-0000">
          ...
          <button type="submit" class="btn-primary" style="margin-top: 20px;">CADASTRAR</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cpfInput.addEventListener('input', function(e) {
        ...
        if (v.length === 14) {
            if (!isCPFValido(v)) {
                this.style.borderBottomColor = 'red'; // Linha fica vermelha se for falso
                this.setCustomValidity('CPF inválido'); // Bloqueia o envio do formulário
            } else {
